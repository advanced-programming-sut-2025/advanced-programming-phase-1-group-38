...
public enum TreeType {
    ...
    OAK("Oak", TreeSeedType.ACORN, "7-7-7-7", 28, SyrupType.OAK_RESIN, 7, List.of(Seasons.SPECIAL), false),
    MAPLE("Maple", TreeSeedType.MAPLE_SEED, "7-7-7-7", 28, SyrupType.MAPLE_SYRUP, 9, List.of(Seasons.SPECIAL), false),
    PINE("Pine", TreeSeedType.PINE_CONE, "7-7-7-7", 28, SyrupType.PINE_TAR, 5, List.of(Seasons.SPECIAL), false),
    MAHOGANY("Mahogany", TreeSeedType.MAHOGANY_SEED, "7-7-7-7", 28, SyrupType.SAP, 1, List.of(Seasons.SPECIAL), false),
    MUSHROOM("Mushroom", TreeSeedType.MUSHROOM_SEED, "7-7-7-7", 28, FruitType.COMMON_MUSHROOM, 1, List.of(Seasons.SPECIAL), false),
    MYSTIC("Mystic", TreeSeedType.MUSHROOM_SEED, "7-7-7-7", 28, SyrupType.MYSTIC_SYRUP, 7, List.of(Seasons.SPECIAL), false),
