...
//import io.github.StardewValley.models.Artisan.*;
...
//import io.github.StardewValley.models.enums.Types.*;
//import io.github.StardewValley.models.farming.*;
//import io.github.StardewValley.models.recipe.CookingRecipe;
...
//
//        Item rewardItem;
//        Object reward = quest.getReward();
//        String rewardName = reward.getClass().getSimpleName();
//        int rewardAmt = quest.getRewardAmount();
//
//        if (reward instanceof CropType ct) {
//            rewardItem = new HarvestedCrop(ct);
//        } else if (reward instanceof FruitType ft) {
//            rewardItem = new Fruit(ft);
//        } else if (reward instanceof StoneType st) {
//            rewardItem = new Stone(st);
//        } else if (reward instanceof ForagingMineralTypes mt) {
//            rewardItem = new ForagingMineral(mt);
//        } else if (reward instanceof ArtisanProductType ap) {
